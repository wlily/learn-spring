...
public class UserControllerTest {
    ...
    public void testhandle9() {
        ...
        restTemplate.postForLocation(
                "http://localhost:8080/chapter15/user/handle9.html", form);
    }

    	@Test
    public void testhandle10() throws IOException {
        RestTemplate restTemplate = new RestTemplate();
        byte[] response = restTemplate.postForObject(
                "http://localhost:8080/chapter15/user/handle10/{itemId}.html", null, byte[].class, "1233");
        Resource outFile = new FileSystemResource("image_copy.jpg");
...
//    	@Test
    public void testhandle11() {
        ...
        form.add("age", "45");
        restTemplate.postForLocation(
                "http://localhost:8080/chapter15/user/handle11.html", form);
    }

//        @Test
    public void testhandle12() throws IOException {
        RestTemplate restTemplate = new RestTemplate();
        byte[] response = restTemplate.postForObject(
                "http://localhost:8080/chapter15/user/handle12/{itemId}.html", null, byte[].class, "1233");
        Resource outFile = new FileSystemResource("image_copy.jpg");
        FileCopyUtils.copy(response, outFile.getFile());
    }
    ...
    public void testhandle13WithXml() {
        ...
        ResponseEntity<User> responseEntity = restTemplate.exchange(
                "http://localhost:8080/chapter15/user/handle13",
    ...
    private RestTemplate buildRestTemplate() {
        ...
        @Test
    public void testhandle13WithJson() {
        RestTemplate restTemplate = buildRestTemplate();
